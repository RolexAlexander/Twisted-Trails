...
// int current_level = 0;
// int game_state = 0; // 0 = intro, 1 = playing, 2 = instructions, 3 = win, 4 = asking_question, 5 = instructions, 6 = leaderboard, 7 = settings, 8 = help
...
//         else if(game_state == 1 || game_state == 4 || game_state == 5 || game_state == 3){
//             // Draw maze
